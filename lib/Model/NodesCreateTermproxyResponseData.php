...
class NodesCreateTermproxyResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets port
     *
     * @param int $port port used to bind termproxy to
     *
     * @return self
     */
     ...
     * Sets ticket
     *
     * @param string $ticket ticket used to verifiy websocket connection
     *
     * @return self
     */
     ...
     * Sets upid
     *
     * @param string $upid UPID for termproxy worker task
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string $user user or authid encoded in the ticket
     *
     * @return self
     */
